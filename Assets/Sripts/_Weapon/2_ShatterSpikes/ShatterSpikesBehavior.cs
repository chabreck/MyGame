...
public class ShatterSpikesBehavior : MonoBehaviour, IWeaponBehavior
{
    private ShatterSpikesWeapon data;
    private int level = 1;
    ...
    {
        this.owner = owner;
        data = wb as ShatterSpikesWeapon;
    ...
    private void ShootSpikes()
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            ShatterSpikesBullet spike = go.GetComponent<ShatterSpikesBullet>();
            if (spike == null)
            {
                spike = go.AddComponent<ShatterSpikesBullet>();
            }
