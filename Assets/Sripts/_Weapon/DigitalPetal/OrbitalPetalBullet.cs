...
public class OrbitalPetalBullet : MonoBehaviour
{
    private GameObject owner;
    private OrbitalPetalBehavior controller;
    ...
    public void Configure(GameObject owner, OrbitalPetalBehavior controller, float damage, float hitCooldownPerEnemy, bool continuous, float cooldown)
    {
        this.owner = owner;
