...
public class OrbitalPetalBehavior : MonoBehaviour, IWeaponBehavior
{
    ...
    private void RebuildPetals()
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            var petalComp = p.GetComponent<OrbitalPetalBullet>();
            if (petalComp == null) petalComp = p.AddComponent<OrbitalPetalBullet>();
